...
<h1 class=" font-semibold mb-2 mt-5 pt-10 text-2xl text-black" >Informasi</h1>

    <div class="max-w-[1400px] w-full pb-5 mx-auto mt-2 overflow-x-auto scrollbar-sangar">
