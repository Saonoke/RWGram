...
<div class="flex justify-between flex-wrap lg:flex-nowrap gap-3">
    ...
    <div class=" w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
        <div class="flex justify-between items-start w-full">
            <div class="flex-col items-center">
              <div class="flex items-center mb-1">
                  <h5 class="text-xl font-bold leading-none text-neutral-10 dark:text-white me-1">Statistik Penduduk</h5>
            </div>
        ...
        data-dropdown-placement="bottom" type="button" class="px-5 py-3 inline-flex items-center text-sm font-semibold text-neutral-10 focus:outline-none bg-white rounded-full border border-neutral-04 hover:bg-neutral-03 focus:z-10  focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Kriteria <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        </svg></button>
            <div id="widgetDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg drop-shadow-card w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-neutral-10 font-semibold dark:text-gray-200" aria-labelledby="widgetDropdownButton">
                  <li>
                    <button  data="pekerjaan" class="stat px-4 py-2 hover:bg-neutral-03 w-full dark:hover:bg-gray-600 dark:hover:text-white">
                      Pekerjaan
                    </button>
                  </li>
                  <li>
                    <button data="tinggal" class="stat px-4 py-2 hover:bg-neutral-03 w-full dark:hover:bg-gray-600 dark:hover:text-white">
                        Status Tinggal
                    </button>
                  </li>
                  <li>
                    <button data="kematian" class="stat px-4 py-2 hover:bg-neutral-03 w-full dark:hover:bg-gray-600 dark:hover:text-white">
                      Kematian
                    </button>
                  </li>
                  <li>
                    <button data="usia" class="stat px-4 py-2 hover:bg-neutral-03 w-full dark:hover:bg-gray-600 dark:hover:text-white">
                      Usia
                    </button>
                  </li>
                </ul>
        ...
        <div class="py-6" id="pie-chart"></div>
         ...
         <div class="w-full">
             <div class=" w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
                <h1 class=" font-bold mb-4 text-neutral-10 text-xl" >Jumlah Penduduk</h1>
              <div class="mb-3 w-full flex gap-5 justify-end">
                <div class="flex gap-1 flex-col text-sm font-semibold">
                ...
                <div class="h-full">
                  <button id="dateRangeButton" data-dropdown-toggle="dateRangeDropdown" data-dropdown-ignore-click-outside-class="datepicker" type="button"  class="px-5 py-3 inline-flex items-center text-sm font-semibold text-neutral-10 focus:outline-none bg-white rounded-full border border-neutral-04 hover:bg-neutral-03 focus:z-10  focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Tanggal <svg class="w-3 h-3 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                  </svg>
                </button>
                <div id="dateRangeDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg drop-shadow-card w-80 lg:w-96 dark:bg-gray-700 dark:divide-gray-600">
...
@endif
<div class="text-sm px-5 overflow-x-hidden py-6 font-semibold text-center rounded-xl w-full bg-white  text-neutral-06 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">


    <ul x-data="{active: 'umkm'}" class="{{Auth::user()->user_id == '1'?'flex overflow-x-auto -mb-px':'hidden'}}">
        <li class="">
            <button   @click="active = 'umkm'"  :class="active=='umkm' ?'tab text-blue-main border-b-2 border-blue-main  inline-block p-4 rounded-t-lg  dark:hover:text-gray-300 w-[120px]':'tab inline-block p-4 border-b-2 rounded-t-lg hover:text-neutral-07 hover:border-neutral-06 dark:hover:text-gray-300 w-[120px]'"   data="rw" >Semua RT</button>
        </li>
        <li class="">
            <button @click="active = 'nikah'"   :class="active=='nikah' ?'tab text-blue-main border-b-2 border-blue-main  inline-block p-4 rounded-t-lg  dark:hover:text-gray-300 w-[120px]':'tab inline-block p-4 border-b-2 rounded-t-lg hover:text-neutral-07 hover:border-neutral-06 dark:hover:text-gray-300 w-[120px]'"  data="1" aria-current="page">RT 01</button>
        </li>
        <li class="">
            <button @click="active = 'tinggal'"  :class="active=='tinggal' ?'tab text-blue-main border-b-2 border-blue-main  inline-block p-4 rounded-t-lg  dark:hover:text-gray-300 w-[120px]':'tab inline-block p-4 border-b-2 rounded-t-lg hover:text-neutral-07 hover:border-neutral-06 dark:hover:text-gray-300 w-[120px]'"  data="2">RT 02</button>
        </l px-3i>
        <li class="">
            <button @click="active = 'meninggal'"    :class="active=='meninggal' ?'tab text-blue-main border-b-2 border-blue-main  inline-block p-4 rounded-t-lg  dark:hover:text-gray-300 w-[120px]':'tab inline-block p-4 border-b-2 rounded-t-lg hover:text-neutral-07 hover:border-neutral-06 dark:hover:text-gray-300 w-[120px]'"  data="3">RT 03</button>
        </li>
        <li class="">
            <button @click="active = 'baru'"  :class="active=='baru' ?'tab text-blue-main border-b-2 border-blue-main  inline-block p-4 rounded-t-lg  dark:hover:text-gray-300 w-[120px]':'tab inline-block p-4 border-b-2 rounded-t-lg hover:text-neutral-07 hover:border-neutral-06 dark:hover:text-gray-300 w-[120px]'"  data="4">RT 04</button>
        </li>
    </ul>



    <div class="flex flex-wrap md:flex-nowrap mt-8 w-full gap-3 lg:gap-0  justify-between items-center ">
