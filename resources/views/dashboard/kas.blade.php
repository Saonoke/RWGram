                            ...
                            <form action="{{url('/kas')}}" method="POST"  class="p-4 md:p-5 text-left">
                              ...
                              <div class="grid gap-4 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-2">
                                  ...
                                  <input readonly type="text" name="nama_user" id="name" value="{{$item->user->nama_user}}" class=" border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="NKK" required="">
                              </div>
