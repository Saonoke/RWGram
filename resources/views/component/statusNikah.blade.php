    ...
    <tbody id="body">
         ...
         <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="px-6 py-4 flex gap-3">
                ...
                <div x-data="{ open: false }">
                    <button @click="open = true"  class="before:absolute text-dodger-blue-800 bg-blue-50 hover:bg-blue-100  border hover:border-dodger-blue-800 border-dodger-blue-800 px-5 py-2 text-base font-bold rounded-full" type="button">
                        Detail
                      </button>
                        ...
                        <div  class="absolute w-full max-w-[920px] h-[80vh] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  p-4  z-50 ">
                              ...
                              <div @click.outside="open = false" class="relative bg-white w-full  rounded-lg shadow dark:bg-gray-700">
                                  ...
                                  <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                                      ...
                                      <button type="button" @click="open = false" class="absolute -top-5 -right-4 bg-blue-main   text-white border-2 border-white hover:bg-gray-200 hover:text-neutral-10 rounded-full text-sm w-8 h-8 ms-auto inline-flex justify-center items-center ">
                                  ...
                                  <form class="p-4 md:p-5">
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            <label for="name" class="block mb-2 text-sm font-medium text-neutral-06 dark:text-white">Nama Pengaju</label>
                                        ...
                                        <div class="col-span-2">
                                            <label for="name" class="block mb-2 text-sm font-medium text-neutral-06 dark:text-white">Nama Pasangan</label>
                                        ...
                                        <div class="col-span-2">
                                          <label for="name" class="block mb-2 text-sm font-medium text-neutral-06 dark:text-white">Status</label>
                                      ...
                                      <div class="col-span-2">
                                          <label for="name" class="block mb-2 text-sm font-medium text-neutral-06 dark:text-white">Gambar</label>
                                          <img src="{{$status->foto_bukti == null ? 'https://res.cloudinary.com/dtzlizlrs/image/upload/v1717600035/qcwtusubd3trexvgfcre.jpg' : $status->foto_bukti }}" alt="Foto Bukti" class="rounded-lg">
                                      </div>
                                    </div>
                ...
                <form action="{{url('/delete/nikah/'.$status->id_status_nikah)}}" onsubmit="return alert('are You sure ?')" method="post">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="px-8 py-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
