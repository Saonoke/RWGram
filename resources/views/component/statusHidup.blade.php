    ...
    <tbody id="body">
         ...
         <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td class="px-6 py-4 flex gap-3">
                    ...
                    <div x-show="open"  class="overflow-y-auto overflow-x-hidden fixed  z-40 justify-center items-center w-full inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div @click.outside="open = false" class="absolute text-center w-full max-w-[500px] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl  p-4 bg-white z-50 text-neutral-10">
                           ...
                           <div class="flex w-full space-x-7 justify-center">
                            <button @click="open= false" class="text-blue-main border hover:bg-blue-10 px-5 py-2 text-base font-bold rounded-full">Batal</button>
                              ...
                              <div @click.outside="open = false" class="relative bg-white w-full  rounded-lg shadow dark:bg-gray-700">
                                  ...
                                  <form class="p-4 md:p-5">
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        ...
                                        <div class="col-span-2">
                                            <label for="name" class="block mb-2 text-sm font-medium text-neutral-06 dark:text-white">Nama Meninggal</label>
                                        ...
                                        <div class="col-span-2">
                                            <label for="name" class="block mb-2 text-sm font-medium text-neutral-06 dark:text-white">NIK Meninggal</label>
                                      ...
                                      <div class="col-span-2">
                                          ...
                                          <img src="{{$status->foto_bukti == null ? 'https://res.cloudinary.com/dtzlizlrs/image/upload/v1717600837/vutkd8upi1jqty2c8tmf.jpg' : $status->foto_bukti}}" alt="Foto Bukti" class="rounded-lg">
                                      </div>
                                    </div>
                ...
                <form action="{{url('/delete/hidup/'.$status->id_status_hidup)}}" onsubmit="return alert('are You sure ?')" method="post">
                    @csrf
                    @method('DELETE')
