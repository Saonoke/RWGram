                                      ...
                                      <form class="p-4 md:p-5">
                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                          ...
                                          <div class="col-span-2">
                                              ...
                                              <textarea readonly id="description" rows="4" style="text-transform: capitalize;" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  placeholder="Write product description here">{{$item->deskripsi_umkm}}</textarea>           
                                          </div>
                                          <div class="col-span-2">
