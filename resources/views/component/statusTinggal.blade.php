                                  ...
                                  <form class="p-4 md:p-5">
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                      ...
                                      <div class="col-span-2">
                                          ...
                                          <img src="{{$status->foto_bukti == null ? 'https://res.cloudinary.com/dtzlizlrs/image/upload/v1717600033/iwdegpqxxpfvswea52g8.jpg': $status->foto_bukti}}" alt="Foto Bukti" class="rounded-lg">
                                      </div>
                                    </div>
